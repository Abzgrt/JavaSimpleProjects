 ...
 * @author Abdi
 */
public class GUI_Calculator extends Frame{
...
///////////////////////////  
GUI_Calculator(String frameText)//constructor  
{  
super(frameText);  
...
//////////////////////////////////////////  
MyDigitButton(int x,int y, int width,int height,String cap, GUI_Calculator clc)  
{  
super(cap);  
...
MyOperatorButton(int x,int y, int width,int height,String cap, GUI_Calculator clc)  
{  
super(cap);  
setBounds(x,y,width,height);  
this.cl=clc;  
...
if(opText.equals("1/x"))  
    ...
    try  
        ...
        cl.displayLabel.setText(GUI_Calculator.getFormattedText(tempd));}  
...
cl.displayLabel.setText(GUI_Calculator.getFormattedText(temp));  
//cl.number=temp;  
}//actionPerformed  
}//class  
...
/////////////////////////////////  
MyMemoryButton(int x,int y, int width,int height,String cap, GUI_Calculator clc)  
{  
super(cap);  
setBounds(x,y,width,height);  
this.cl=clc;  
...
case 'R':   
    cl.displayLabel.setText(GUI_Calculator.getFormattedText(cl.memValue));break;  
case 'S':  
    cl.memValue=0.0;  
case '+':   
...
MySpecialButton(int x,int y, int width,int height,String cap, GUI_Calculator clc)  
{  
super(cap);  
setBounds(x,y,width,height);  
this.cl=clc;  
